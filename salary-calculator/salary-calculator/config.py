...
# ── 임금협상 소급 구조 (우리 병원 특이사항) ────────────
# 인상률은 9월에 확정되어, 9월 급여부터 인상된 기본급표가 바로 적용됨.
# 3~8월은 인상 전 기본급으로 매달 지급하고, 9월에 3~8월 차액(6개월치)을
# "소급인상분"으로 한 번에 지급 (9월분 자체는 이미 인상된 기본급으로 정상 지급).
RAISE_EFFECTIVE_MONTH = 9    # 이 달부터 인상된 기본급표로 매달 지급
RETRO_START_MONTH = 3        # 소급 대상 시작월
RETRO_END_MONTH = 8          # 소급 대상 끝월 (포함)
RETRO_PAY_MONTH = 9          # 소급분을 실제 지급하는 달
